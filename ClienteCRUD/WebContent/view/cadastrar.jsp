		  ...
		  <div class="row">
		  	<div class="col-md-2">
				  ...
				  <li class="nav-item my-5">
				    <a class="nav-link active" href="http://localhost:8080/clientes/view/cadastrar.jsp">Cadastrar Cliente</a>
				  </li>
				  <li class="nav-item my-5">
			...
			<div class="col-md-10">
				<h3 class="text-center my-3">Cadastrar Clientes</h3>
				<form method="post" action="../Controller?operacao=cadastrar">
